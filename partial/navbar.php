...
<nav class="navbar navbar-expand-lg navbar-light bg-dark position-sticky sticky-top">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    <li class="nav-item active">
        <a class="nav-link text-light" href="?page=home"><i class="fa fa-home" style="font-size:28px"></i><span class="sr-only">(current)</span></a>
      </li>
      <li class="nav-item">
        <a class="nav-link text-light" href="?page=entertainment" style="font-size:20px">កំសាន្ត</a>
      </li>
      <li class="nav-item">
        <a class="nav-link text-light" href="?page=sport" style="font-size:20px">កីឡា</a>
      </li>
      <li class="nav-item">
        <a class="nav-link text-light" href="?page=society" style="font-size:20px">សង្គម</a>
      </li>
      <li class="nav-item">
        <a class="nav-link text-light" href="?page=technology" style="font-size:20px">បច្ចេកវិទ្យា</a>
      </li>
    </ul>
